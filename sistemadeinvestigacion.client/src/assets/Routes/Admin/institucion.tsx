...
/** * REGISTRO INSTITUCIÓN V5.0 - PDI Intranet 2026
 * Fix: URL Object Cleanup, AbortController en FormData, y estabilidad de punteros.
 */
...
// 1. Estilos constantes fuera del render para evitar recreación de strings
...
export default function Institucion() {
    ...
    // Estados del formulario agrupados para reducir micro-renders
    ...
    // 2. CORRECCIÓN CRÍTICA: Cleanup de URL.createObjectURL (Memory Leak masivo de imágenes)
    useEffect(() => {
        return () => {
    ...
    const handleLogoChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        // Limpiamos la URL anterior antes de crear una nueva
        if (logoPreview) URL.revokeObjectURL(logoPreview);
                        ...
                        <div className="flex-1 overflow-y-auto p-10 md:p-14 custom-list-scroll">
                            ...
                            <form className="grid grid-cols-1 lg:grid-cols-2 gap-12 pb-20">
                                <div className="space-y-8">
                                    ...
                                    <div>
                                        <label className={LABEL_STYLE}>Nombre Oficial *</label>
                                    ...
                                    <div>
                                        <label className={LABEL_STYLE}><FileText size={12} /> Reseña *</label>
                                ...
                                <div className="space-y-8">
                                    <div className="border-b border-slate-100 pb-2">
                                        <h3 className="text-[11px] font-black text-[#002855] uppercase tracking-[0.2em]">Branding</h3>
                                    </div>
                                    <div>
